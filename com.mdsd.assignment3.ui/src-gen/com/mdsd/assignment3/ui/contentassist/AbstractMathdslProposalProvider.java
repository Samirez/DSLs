 ...
 */
package com.mdsd.assignment3.ui.contentassist;
...
public abstract class AbstractMathdslProposalProvider extends TerminalsProposalProvider {
	...
	public void completeMathExp_External(EObject model, Assignment assignment, ContentAssistContext context, ICompletionProposalAcceptor acceptor) {
		completeRuleCall(((RuleCall)assignment.getTerminal()), context, acceptor);
	}
	...
	public void complete_ExternalArgument(EObject model, RuleCall ruleCall, ContentAssistContext context, ICompletionProposalAcceptor acceptor) {
		// subclasses may override
	}
