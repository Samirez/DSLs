 ...
 */
package com.mdsd.assignment3.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import com.mdsd.assignment3.ide.contentassist.antlr.internal.InternalMathdslParser;
...
public class MathdslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathdslGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getExternalAccess().getAlternatives_2(), "rule__External__Alternatives_2");
			builder.put(grammarAccess.getExternalUseAccess().getAlternatives_1(), "rule__ExternalUse__Alternatives_1");
			...
			builder.put(grammarAccess.getExternalAccess().getGroup_2_1_2(), "rule__External__Group_2_1_2__0");
			builder.put(grammarAccess.getExternalUseAccess().getGroup(), "rule__ExternalUse__Group__0");
			builder.put(grammarAccess.getExternalUseAccess().getGroup_1_1(), "rule__ExternalUse__Group_1_1__0");
			builder.put(grammarAccess.getExternalUseAccess().getGroup_1_1_2(), "rule__ExternalUse__Group_1_1_2__0");
			...
			builder.put(grammarAccess.getMathExpAccess().getExternalAssignment_2(), "rule__MathExp__ExternalAssignment_2");
			...
			builder.put(grammarAccess.getExternalAccess().getArgumentsAssignment_2_1_1(), "rule__External__ArgumentsAssignment_2_1_1");
			builder.put(grammarAccess.getExternalAccess().getArgumentsAssignment_2_1_2_1(), "rule__External__ArgumentsAssignment_2_1_2_1");
			builder.put(grammarAccess.getExternalUseAccess().getRefAssignment_0(), "rule__ExternalUse__RefAssignment_0");
			builder.put(grammarAccess.getExternalUseAccess().getArgumentsAssignment_1_1_1(), "rule__ExternalUse__ArgumentsAssignment_1_1_1");
			builder.put(grammarAccess.getExternalUseAccess().getArgumentsAssignment_1_1_2_1(), "rule__ExternalUse__ArgumentsAssignment_1_1_2_1");
